...
x_train =tf.random.normal([64,   64 ,64 ,128], 0, 3, tf.float32, seed=1)
y_train =tf.random.normal([64,   64 ,64 ,128], 0, 3, tf.float32, seed=2)
...
output = usefull_blocks.UniteAndDivideAttentionModule(16)
